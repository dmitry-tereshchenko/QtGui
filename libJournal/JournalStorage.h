...
******************************************************************************************************************************/
    ...
    static QString printableColor(Level level)
    {
        ...
        case TraceCalls: return "\e[38;5;031m"+printable(level);
        case TrackRuntime: return "\e[38;5;048m"+printable(level);
        case TrackParameters: return "\e[38;5;038m"+printable(level);
