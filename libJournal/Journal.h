...
protected:
    ...
    /**
     * @brief Конструктор защищен: журнал - мульти-синглтон в пределах процесса
     */
...
public:
    ...
    /**
     * @brief Статическая функция выдает указатель на экземпляр журнала
     */
...
private:
    ...
    std::vector<JournalStorage*>                      m_storages;      ///< Объект хранилища
